...
save(mcmc.out.log, file = "martin_results_with_slides/mcmc_output_log.Rda")
```

```{r, include = FALSE}
library(coda)
if(!recalculate)
  load("martin_results_with_slides/mcmc_output_log.Rda")
...
mcmc.out.slice <- runMCMC(compiled$mcmc, niter = 30000, 
                          nchains = 3, nburnin = 10000, samplesAsCodaMCMC = TRUE)
save(mcmc.out.slice, file = "martin_results_with_slides/mcmc_output_slice.Rda")
```

```{r, include = FALSE}
library(coda)
if(!recalculate)
  load("martin_results_with_slides/mcmc_output_slice.Rda")
...
mcmc.out.block <- runMCMC(compiled$mcmc, niter = 30000, 
                          nchains = 3, nburnin = 10000, samplesAsCodaMCMC = TRUE)
save(mcmc.out.block, file = "martin_results_with_slides/mcmc_output_block.Rda")
```

```{r, include = FALSE}
library(coda)
if(!recalculate)
  load("martin_results_with_slides/mcmc_output_block.Rda")
...
mcmc.out.hmc <- runMCMC(cHMC, niter = 30000, 
                          nchains = 3, nburnin = 10000, samplesAsCodaMCMC = TRUE)
save(mcmc.out.hmc, file = "martin_results_with_slides/mcmc_output_hmc.Rda")
```

```{r, include = FALSE}
library(coda)
if(!recalculate)
  load("martin_results_with_slides/mcmc_output_hmc.Rda")
...
Bonus Writing your own sampler
=====
